...
func (g AdjacencyList) BronKerbosch1(emit func([]NI) bool) {
...
//
// There are equivalent labeled and unlabeled versions of this method.
func (g AdjacencyList) BKPivotMinP(P, X *bitset.BitSet) int {
	n, _ := P.NextSet(0)
	return int(n)
}
...
// BronKerbosch3.
func (g AdjacencyList) BronKerbosch2(pivot func(P, X *bitset.BitSet) int, emit func([]NI) bool) {
	var f func(R, P, X *bitset.BitSet) bool
	f = func(R, P, X *bitset.BitSet) bool {
		switch {
		case P.Any():
...
func (g AdjacencyList) BronKerbosch3(pivot func(P, X *bitset.BitSet) int, emit func([]NI) bool) {
	var f func(R, P, X *bitset.BitSet) bool
	f = func(R, P, X *bitset.BitSet) bool {
		switch {
		case P.Any():
...
//
// There are equivalent labeled and unlabeled versions of this method.
func (g AdjacencyList) Cyclic() (cyclic bool, fr NI, to NI) {
	fr, to = -1, -1
...
//
// There are equivalent labeled and unlabeled versions of this method.
func (g AdjacencyList) FromList() (*FromList, NI) {
	// init paths
...
func (g AdjacencyList) Tarjan(emit func([]NI) bool) {
...
func (g AdjacencyList) TarjanForward() [][]NI {
	var r [][]NI
