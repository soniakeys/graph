...
//
// There are equivalent labeled and unlabeled versions of this method.
func (g AdjacencyList) DepthFirst(start NI, bm *bits.Bits, v OkNodeVisitor) (ok bool) {
	if bm == nil {
		if v == nil {
			return false
		}
...
//
// There are equivalent labeled and unlabeled versions of this method.
func (g AdjacencyList) DepthFirstRandom(start NI, bm *bits.Bits, v OkNodeVisitor, r *rand.Rand) (ok bool) {
	if bm == nil {
		if v == nil {
			return false
		}
